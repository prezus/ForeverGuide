-- AUTO-GENERATED by tools/compile_guides.py from guides-src/GEN_ALLIANCE_SKYBORNE_42_UN_GORO_CRATER.json - DO NOT EDIT
local _, ns = ...
ns.RegisterGuide({
    id = "GEN_ALLIANCE_SKYBORNE_42_UN_GORO_CRATER",
    name = "42. Un'Goro Crater 53-54 (Skyborne)",
    version = 2,
    faction = "Alliance",
    race = { "Skyborne" },
    minLevel = 53,
    ...
    map = 1449,
    zone = "Un'Goro Crater",
    next = "GEN_ALLIANCE_SKYBORNE_43_SILITHUS",
    author = "ForeverGuide route planner",
    notes = "Chapter 42 of the Skyborne route: level 53 to 54, 14 steps, ~96 min of play in the model (15492 xp/h). Route tuned for xp per hour: low-value quests and long escorts are skipped on purpose; group (elite) quests appear as optional steps.",
    stepCount = 14,
