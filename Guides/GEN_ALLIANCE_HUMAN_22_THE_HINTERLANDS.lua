-- AUTO-GENERATED by tools/compile_guides.py from guides-src/GEN_ALLIANCE_HUMAN_22_THE_HINTERLANDS.json - DO NOT EDIT
local _, ns = ...
ns.RegisterGuide({
    ...
    notes = "Chapter 22 of the Human route: level 42 to 45, 18 steps, ~475 min of play in the model (10484 xp/h). Route tuned for xp per hour: low-value quests and long escorts are skipped on purpose; group (elite) quests appear as optional steps.",
    stepCount = 18,
