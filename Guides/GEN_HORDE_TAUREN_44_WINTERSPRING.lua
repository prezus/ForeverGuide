-- AUTO-GENERATED by tools/compile_guides.py from guides-src/GEN_HORDE_TAUREN_44_WINTERSPRING.json - DO NOT EDIT
local _, ns = ...
ns.RegisterGuide({
    id = "GEN_HORDE_TAUREN_44_WINTERSPRING",
    name = "44. Winterspring 56-58 (Tauren)",
    version = 2,
    faction = "Horde",
    race = { "Tauren" },
    minLevel = 56,
    ...
    map = 1452,
    zone = "Winterspring",
    next = "GEN_HORDE_TAUREN_45_SILITHUS",
    author = "ForeverGuide route planner",
    notes = "Chapter 44 of the Tauren route: level 56 to 58, 29 steps, ~565 min of play in the model (7101 xp/h). Route tuned for xp per hour: low-value quests and long escorts are skipped on purpose; group (elite) quests appear as optional steps (1 here).",
    stepCount = 29,
