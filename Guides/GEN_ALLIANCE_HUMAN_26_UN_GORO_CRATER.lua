-- AUTO-GENERATED by tools/compile_guides.py from guides-src/GEN_ALLIANCE_HUMAN_26_UN_GORO_CRATER.json - DO NOT EDIT
local _, ns = ...
ns.RegisterGuide({
    id = "GEN_ALLIANCE_HUMAN_26_UN_GORO_CRATER",
    name = "26. Un'Goro Crater 47-47 (Human)",
    version = 3,
    faction = "Alliance",
    race = { "Human" },
    minLevel = 47,
    ...
    notes = "Chapter 26 of the Human route: level 47 to 47, 26 steps, ~100 min of play in the model (29139 xp/h). Route tuned for xp per hour: low-value quests and long escorts are skipped on purpose; group (elite) quests appear as optional steps.",
    stepCount = 26,
