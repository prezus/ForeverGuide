-- AUTO-GENERATED by tools/compile_guides.py from guides-src/GEN_ZONE_ALLIANCE_LOCH_MODAN.json - DO NOT EDIT
local _, ns = ...
ns.RegisterGuide({
    id = "GEN_ZONE_ALLIANCE_LOCH_MODAN",
    name = "Zone: Loch Modan 10-20 (Alliance)",
    version = 2,
    faction = "Alliance",
    minLevel = 10,
    maxLevel = 20,
