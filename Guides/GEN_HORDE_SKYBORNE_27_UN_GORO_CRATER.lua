-- AUTO-GENERATED by tools/compile_guides.py from guides-src/GEN_HORDE_SKYBORNE_27_UN_GORO_CRATER.json - DO NOT EDIT
local _, ns = ...
ns.RegisterGuide({
    id = "GEN_HORDE_SKYBORNE_27_UN_GORO_CRATER",
    name = "27. Un'Goro Crater 49-49 (Skyborne)",
    version = 3,
    faction = "Horde",
    race = { "Skyborne" },
    minLevel = 49,
    ...
    map = 1449,
    zone = "Un'Goro Crater",
    next = "GEN_HORDE_SKYBORNE_28_ORGRIMMAR",
    author = "ForeverGuide route planner",
    notes = "Chapter 27 of the Skyborne route: level 49 to 49, 13 steps, ~67 min of play in the model (33176 xp/h). Route tuned for xp per hour: low-value quests and long escorts are skipped on purpose; group (elite) quests appear as optional steps.",
    stepCount = 13,
