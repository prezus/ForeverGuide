-- AUTO-GENERATED by tools/compile_guides.py from guides-src/GEN_HORDE_SCOURGE_43_WINTERSPRING.json - DO NOT EDIT
local _, ns = ...
ns.RegisterGuide({
    id = "GEN_HORDE_SCOURGE_43_WINTERSPRING",
    name = "43. Winterspring 56-58 (Undead)",
    version = 2,
    faction = "Horde",
    race = { "Scourge" },
    minLevel = 56,
    ...
    map = 1452,
    zone = "Winterspring",
    next = "GEN_HORDE_SCOURGE_44_SILITHUS",
    author = "ForeverGuide route planner",
    notes = "Chapter 43 of the Scourge route: level 56 to 58, 29 steps, ~565 min of play in the model (7101 xp/h). Route tuned for xp per hour: low-value quests and long escorts are skipped on purpose; group (elite) quests appear as optional steps (1 here).",
    stepCount = 29,
