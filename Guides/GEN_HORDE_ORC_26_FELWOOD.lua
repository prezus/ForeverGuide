-- AUTO-GENERATED by tools/compile_guides.py from guides-src/GEN_HORDE_ORC_26_FELWOOD.json - DO NOT EDIT
local _, ns = ...
ns.RegisterGuide({
    id = "GEN_HORDE_ORC_26_FELWOOD",
    name = "26. Felwood 48-49 (Orc)",
    version = 2,
    faction = "Horde",
    race = { "Orc", "Troll" },
    minLevel = 48,
    ...
    map = 1448,
    zone = "Felwood",
    next = "GEN_HORDE_ORC_27_UN_GORO_CRATER",
    author = "ForeverGuide route planner",
    notes = "Chapter 26 of the Orc route: level 48 to 49, 22 steps, ~85 min of play in the model (42287 xp/h). Route tuned for xp per hour: low-value quests and long escorts are skipped on purpose; group (elite) quests appear as optional steps.",
    stepCount = 22,
