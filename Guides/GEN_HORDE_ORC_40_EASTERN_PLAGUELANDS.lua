-- AUTO-GENERATED by tools/compile_guides.py from guides-src/GEN_HORDE_ORC_40_EASTERN_PLAGUELANDS.json - DO NOT EDIT
local _, ns = ...
ns.RegisterGuide({
    ...
    notes = "Chapter 40 of the Orc route: level 54 to 54, 20 steps, ~81 min of play in the model (50154 xp/h). Route tuned for xp per hour: low-value quests and long escorts are skipped on purpose; group (elite) quests appear as optional steps.",
    stepCount = 20,
