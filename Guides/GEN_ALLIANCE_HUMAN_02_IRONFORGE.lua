...
ns.RegisterGuide({
    ...
    steps = function() return {
        ...
        { type = "TRAVEL", map = 1455, zone = "Ironforge", x = 61.4, y = 48.2, radius = 60, note = "travel to Ironforge (Ironforge)" }, -- 20
        { type = "NOTE", map = 1455, zone = "Ironforge", x = 61.4, y = 48.2, text = "set your hearthstone at the inn in Ironforge (if there is one)" }, -- 21
        { type = "TURNIN", quest = 1679, questName = "Muren Stormpike", npc = 6114, npcName = "Muren Stormpike", map = 1455, zone = "Ironforge", x = 70.6, y = 90.4, class = { "WARRIOR" } }, -- 22
        { type = "ACCEPT", quest = 8372, questName = "Fight for Warsong Gulch", npc = 15351, npcName = "Alliance Brigadier General", map = 1455, zone = "Ironforge", x = 70.4, y = 91.1 }, -- 23
        { type = "TURNIN", quest = 8372, questName = "Fight for Warsong Gulch", npc = 15351, npcName = "Alliance Brigadier General", map = 1455, zone = "Ironforge", x = 70.4, y = 91.1 }, -- 24
        { type = "ACCEPT", quest = 1678, questName = "Vejrek", npc = 6114, npcName = "Muren Stormpike", map = 1455, zone = "Ironforge", x = 70.6, y = 90.4, class = { "WARRIOR" } }, -- 25
