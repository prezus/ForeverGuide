...
ns.RegisterGuide({
    ...
    notes = "Chapter 11 of the Skyborne route: level 29 to 30, 24 steps, ~93 min of play in the model (21961 xp/h). Route tuned for xp per hour: low-value quests and long escorts are skipped on purpose; group (elite) quests appear as optional steps.",
    stepCount = 39,
    steps = function() return {
        ...
        { type = "TURNIN", quest = 559, questName = "Farren's Proof", npc = 2228, npcName = "Lieutenant Farren Orinelle", map = 1424, zone = "Hillsbrad Foothills", x = 51.5, y = 58.4 }, -- 30
        { type = "ACCEPT", quest = 560, questName = "Farren's Proof", npc = 2228, npcName = "Lieutenant Farren Orinelle", map = 1424, zone = "Hillsbrad Foothills", x = 51.5, y = 58.4 }, -- 31
        { type = "TURNIN", quest = 560, questName = "Farren's Proof", npc = 2263, npcName = "Marshal Redpath", map = 1424, zone = "Hillsbrad Foothills", x = 49.5, y = 58.7 }, -- 32
        { type = "TURNIN", quest = 565, questName = "Bartolo's Yeti Fur Cloak", npc = 2438, npcName = "Bartolo Ginsetti", map = 1424, zone = "Hillsbrad Foothills", x = 49.4, y = 55.5 }, -- 33
