-- AUTO-GENERATED by tools/compile_guides.py from guides-src/GEN_HORDE_ORC_25_TANARIS.json - DO NOT EDIT
local _, ns = ...
ns.RegisterGuide({
    id = "GEN_HORDE_ORC_25_TANARIS",
    name = "25. Tanaris 48-48 (Orc)",
    version = 2,
    faction = "Horde",
    race = { "Orc", "Troll" },
    minLevel = 48,
    ...
    map = 1446,
    zone = "Tanaris",
    next = "GEN_HORDE_ORC_26_FELWOOD",
    author = "ForeverGuide route planner",
    notes = "Chapter 25 of the Orc route: level 48 to 48, 19 steps, ~56 min of play in the model (39738 xp/h). Route tuned for xp per hour: low-value quests and long escorts are skipped on purpose; group (elite) quests appear as optional steps (1 here).",
    stepCount = 19,
