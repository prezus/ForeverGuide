-- AUTO-GENERATED by tools/compile_guides.py from guides-src/GEN_ALLIANCE_NIGHTELF_41_WINTERSPRING.json - DO NOT EDIT
local _, ns = ...
ns.RegisterGuide({
    id = "GEN_ALLIANCE_NIGHTELF_41_WINTERSPRING",
    name = "41. Winterspring 53-53 (Night Elf)",
    version = 2,
    faction = "Alliance",
    race = { "NightElf" },
    minLevel = 53,
    ...
    map = 1452,
    zone = "Winterspring",
    next = "GEN_ALLIANCE_NIGHTELF_42_FELWOOD",
    author = "ForeverGuide route planner",
    notes = "Chapter 41 of the NightElf route: level 53 to 53, 28 steps, ~121 min of play in the model (34265 xp/h). Route tuned for xp per hour: low-value quests and long escorts are skipped on purpose; group (elite) quests appear as optional steps.",
    stepCount = 28,
