-- AUTO-GENERATED by tools/compile_guides.py from guides-src/GEN_ALLIANCE_HUMAN_35_EASTERN_PLAGUELANDS.json - DO NOT EDIT
local _, ns = ...
ns.RegisterGuide({
    id = "GEN_ALLIANCE_HUMAN_35_EASTERN_PLAGUELANDS",
    name = "35. Eastern Plaguelands 50-51 (Human)",
    version = 2,
    faction = "Alliance",
    race = { "Human" },
    minLevel = 50,
    ...
    notes = "Chapter 35 of the Human route: level 50 to 51, 14 steps, ~42 min of play in the model (42647 xp/h). Route tuned for xp per hour: low-value quests and long escorts are skipped on purpose; group (elite) quests appear as optional steps.",
    stepCount = 14,
