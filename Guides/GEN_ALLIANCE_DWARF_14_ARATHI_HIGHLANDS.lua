-- AUTO-GENERATED by tools/compile_guides.py from guides-src/GEN_ALLIANCE_DWARF_14_ARATHI_HIGHLANDS.json - DO NOT EDIT
local _, ns = ...
ns.RegisterGuide({
    id = "GEN_ALLIANCE_DWARF_14_ARATHI_HIGHLANDS",
    name = "14. Arathi Highlands 33-33 (Dwarf)",
    version = 2,
    faction = "Alliance",
    race = { "Dwarf", "Gnome" },
    minLevel = 33,
    ...
    next = "GEN_ALLIANCE_DWARF_15_DESOLACE",
    author = "ForeverGuide route planner",
    notes = "Chapter 14 of the Dwarf route: level 33 to 33, 27 steps, ~119 min of play in the model (24457 xp/h). Route tuned for xp per hour: low-value quests and long escorts are skipped on purpose; group (elite) quests appear as optional steps.",
    stepCount = 27,
