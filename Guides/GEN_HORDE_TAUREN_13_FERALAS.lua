-- AUTO-GENERATED by tools/compile_guides.py from guides-src/GEN_HORDE_TAUREN_13_FERALAS.json - DO NOT EDIT
local _, ns = ...
ns.RegisterGuide({
    id = "GEN_HORDE_TAUREN_13_FERALAS",
    name = "13. Feralas 41-42 (Tauren)",
    version = 2,
    faction = "Horde",
    race = { "Tauren" },
    minLevel = 41,
    ...
    map = 1444,
    zone = "Feralas",
    next = "GEN_HORDE_TAUREN_14_DESOLACE",
    author = "ForeverGuide route planner",
    notes = "Chapter 13 of the Tauren route: level 41 to 42, 44 steps, ~172 min of play in the model (39062 xp/h). Route tuned for xp per hour: low-value quests and long escorts are skipped on purpose; group (elite) quests appear as optional steps.",
    stepCount = 44,
