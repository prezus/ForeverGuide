-- AUTO-GENERATED by tools/compile_guides.py from guides-src/GEN_HORDE_TAUREN_33_BURNING_STEPPES.json - DO NOT EDIT
local _, ns = ...
ns.RegisterGuide({
    id = "GEN_HORDE_TAUREN_33_BURNING_STEPPES",
    name = "33. Burning Steppes 50-51 (Tauren)",
    version = 2,
    faction = "Horde",
    race = { "Tauren" },
    minLevel = 50,
    ...
    next = "GEN_HORDE_TAUREN_34_THE_HINTERLANDS",
    author = "ForeverGuide route planner",
    notes = "Chapter 33 of the Tauren route: level 50 to 51, 10 steps, ~148 min of play in the model (40164 xp/h). Route tuned for xp per hour: low-value quests and long escorts are skipped on purpose; group (elite) quests appear as optional steps (1 here).",
    stepCount = 10,
