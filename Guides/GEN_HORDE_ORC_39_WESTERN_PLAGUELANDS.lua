-- AUTO-GENERATED by tools/compile_guides.py from guides-src/GEN_HORDE_ORC_39_WESTERN_PLAGUELANDS.json - DO NOT EDIT
local _, ns = ...
ns.RegisterGuide({
    id = "GEN_HORDE_ORC_39_WESTERN_PLAGUELANDS",
    name = "39. Western Plaguelands 53-54 (Orc)",
    version = 2,
    faction = "Horde",
    race = { "Orc", "Troll" },
    minLevel = 53,
    ...
    notes = "Chapter 39 of the Orc route: level 53 to 54, 13 steps, ~242 min of play in the model (8624 xp/h). Route tuned for xp per hour: low-value quests and long escorts are skipped on purpose; group (elite) quests appear as optional steps.",
    stepCount = 13,
