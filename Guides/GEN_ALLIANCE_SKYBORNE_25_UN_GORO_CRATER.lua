-- AUTO-GENERATED by tools/compile_guides.py from guides-src/GEN_ALLIANCE_SKYBORNE_25_UN_GORO_CRATER.json - DO NOT EDIT
local _, ns = ...
ns.RegisterGuide({
    id = "GEN_ALLIANCE_SKYBORNE_25_UN_GORO_CRATER",
    name = "25. Un'Goro Crater 47-47 (Skyborne)",
    version = 2,
    faction = "Alliance",
    race = { "Skyborne" },
    minLevel = 47,
    ...
    map = 1449,
    zone = "Un'Goro Crater",
    next = "GEN_ALLIANCE_SKYBORNE_26_AZSHARA",
    author = "ForeverGuide route planner",
    notes = "Chapter 25 of the Skyborne route: level 47 to 47, 27 steps, ~67 min of play in the model (43159 xp/h). Route tuned for xp per hour: low-value quests and long escorts are skipped on purpose; group (elite) quests appear as optional steps.",
    stepCount = 27,
