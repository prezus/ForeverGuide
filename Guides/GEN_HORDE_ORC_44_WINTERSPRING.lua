-- AUTO-GENERATED by tools/compile_guides.py from guides-src/GEN_HORDE_ORC_44_WINTERSPRING.json - DO NOT EDIT
local _, ns = ...
ns.RegisterGuide({
    id = "GEN_HORDE_ORC_44_WINTERSPRING",
    name = "44. Winterspring 56-58 (Orc)",
    version = 2,
    faction = "Horde",
    race = { "Orc", "Troll" },
    minLevel = 56,
    ...
    map = 1452,
    zone = "Winterspring",
    next = "GEN_HORDE_ORC_45_SILITHUS",
    author = "ForeverGuide route planner",
    notes = "Chapter 44 of the Orc route: level 56 to 58, 29 steps, ~565 min of play in the model (7101 xp/h). Route tuned for xp per hour: low-value quests and long escorts are skipped on purpose; group (elite) quests appear as optional steps (1 here).",
    stepCount = 29,
