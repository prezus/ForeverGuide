-- AUTO-GENERATED by tools/compile_guides.py from guides-src/GEN_ALLIANCE_HUMAN_23_IRONFORGE.json - DO NOT EDIT
local _, ns = ...
ns.RegisterGuide({
    id = "GEN_ALLIANCE_HUMAN_23_IRONFORGE",
    name = "23. Ironforge 45-45 (Human)",
    version = 2,
    faction = "Alliance",
    race = { "Human" },
    minLevel = 45,
