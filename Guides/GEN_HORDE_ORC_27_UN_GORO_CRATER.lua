-- AUTO-GENERATED by tools/compile_guides.py from guides-src/GEN_HORDE_ORC_27_UN_GORO_CRATER.json - DO NOT EDIT
local _, ns = ...
ns.RegisterGuide({
    id = "GEN_HORDE_ORC_27_UN_GORO_CRATER",
    name = "27. Un'Goro Crater 49-49 (Orc)",
    version = 2,
    faction = "Horde",
    race = { "Orc", "Troll" },
    minLevel = 49,
    ...
    map = 1449,
    zone = "Un'Goro Crater",
    next = "GEN_HORDE_ORC_28_ORGRIMMAR",
    author = "ForeverGuide route planner",
    notes = "Chapter 27 of the Orc route: level 49 to 49, 13 steps, ~67 min of play in the model (33176 xp/h). Route tuned for xp per hour: low-value quests and long escorts are skipped on purpose; group (elite) quests appear as optional steps.",
    stepCount = 13,
