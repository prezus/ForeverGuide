-- AUTO-GENERATED by tools/compile_guides.py from guides-src/GEN_ALLIANCE_HUMAN_49_WINTERSPRING.json - DO NOT EDIT
local _, ns = ...
ns.RegisterGuide({
    id = "GEN_ALLIANCE_HUMAN_49_WINTERSPRING",
    name = "49. Winterspring 58-60 (Human)",
    version = 2,
    faction = "Alliance",
    race = { "Human" },
    minLevel = 58,
    ...
    notes = "Chapter 49 of the Human route: level 58 to 60, 8 steps, ~566 min of play in the model (1903 xp/h). Route tuned for xp per hour: low-value quests and long escorts are skipped on purpose; group (elite) quests appear as optional steps.",
    stepCount = 8,
