-- AUTO-GENERATED by tools/compile_guides.py from guides-src/GEN_ALLIANCE_SKYBORNE_39_WESTERN_PLAGUELANDS.json - DO NOT EDIT
local _, ns = ...
ns.RegisterGuide({
    id = "GEN_ALLIANCE_SKYBORNE_39_WESTERN_PLAGUELANDS",
    name = "39. Western Plaguelands 53-53 (Skyborne)",
    version = 2,
    faction = "Alliance",
    race = { "Skyborne" },
    minLevel = 53,
    ...
    next = "GEN_ALLIANCE_SKYBORNE_40_WINTERSPRING",
    author = "ForeverGuide route planner",
    notes = "Chapter 39 of the Skyborne route: level 53 to 53, 7 steps, ~17 min of play in the model (54042 xp/h). Route tuned for xp per hour: low-value quests and long escorts are skipped on purpose; group (elite) quests appear as optional steps.",
    stepCount = 7,
