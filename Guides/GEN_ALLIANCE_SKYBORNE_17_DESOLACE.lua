-- AUTO-GENERATED by tools/compile_guides.py from guides-src/GEN_ALLIANCE_SKYBORNE_17_DESOLACE.json - DO NOT EDIT
local _, ns = ...
ns.RegisterGuide({
    id = "GEN_ALLIANCE_SKYBORNE_17_DESOLACE",
    name = "17. Desolace 38-40 (Skyborne)",
    version = 3,
    faction = "Alliance",
    race = { "Skyborne" },
    minLevel = 38,
    ...
    notes = "Chapter 17 of the Skyborne route: level 38 to 40, 74 steps, ~187 min of play in the model (30618 xp/h). Route tuned for xp per hour: low-value quests and long escorts are skipped on purpose; group (elite) quests appear as optional steps (1 here).",
    stepCount = 74,
    steps = function() return {
        ...
        { type = "TURNIN", quest = 1437, questName = "Vahlarriel's Search", map = 1443, zone = "Desolace", x = 56.5, y = 17.8, note = "reduced xp (80%) - you out-levelled it" }, -- 15
        { type = "ACCEPT", quest = 1465, questName = "Vahlarriel's Search", map = 1443, zone = "Desolace", x = 56.5, y = 17.8 }, -- 16
        { type = "TURNIN", quest = 1465, questName = "Vahlarriel's Search", npc = 5642, npcName = "Vahlarriel Demonslayer", map = 1443, zone = "Desolace", x = 66.4, y = 11.8, note = "reduced xp (80%) - you out-levelled it" }, -- 17
        ...
        { type = "TURNIN", quest = 1438, questName = "Vahlarriel's Search", npc = 5644, npcName = "Dalinda Malem", map = 1443, zone = "Desolace", x = 54.9, y = 26.1, note = "reduced xp (80%) - you out-levelled it" }, -- 19
        ...
        { type = "TURNIN", quest = 1439, questName = "Search for Tyranis", npc = 5644, npcName = "Dalinda Malem", map = 1443, zone = "Desolace", x = 54.9, y = 26.1, note = "reduced xp (80%) - you out-levelled it" }, -- 22
        ...
        { type = "TURNIN", quest = 1440, questName = "Return to Vahlarriel", npc = 5642, npcName = "Vahlarriel Demonslayer", map = 1443, zone = "Desolace", x = 66.4, y = 11.8, note = "reduced xp (80%) - you out-levelled it" }, -- 25
