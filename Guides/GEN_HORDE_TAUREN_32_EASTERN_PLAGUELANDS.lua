-- AUTO-GENERATED by tools/compile_guides.py from guides-src/GEN_HORDE_TAUREN_32_EASTERN_PLAGUELANDS.json - DO NOT EDIT
local _, ns = ...
ns.RegisterGuide({
    id = "GEN_HORDE_TAUREN_32_EASTERN_PLAGUELANDS",
    name = "32. Eastern Plaguelands 50-50 (Tauren)",
    version = 2,
    faction = "Horde",
    race = { "Tauren" },
    minLevel = 50,
    ...
    next = "GEN_HORDE_TAUREN_33_BURNING_STEPPES",
    author = "ForeverGuide route planner",
    notes = "Chapter 32 of the Tauren route: level 50 to 50, 14 steps, ~54 min of play in the model (33163 xp/h). Route tuned for xp per hour: low-value quests and long escorts are skipped on purpose; group (elite) quests appear as optional steps.",
    stepCount = 14,
