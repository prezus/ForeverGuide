-- AUTO-GENERATED by tools/compile_guides.py from guides-src/GEN_HORDE_ORC_42_EASTERN_PLAGUELANDS.json - DO NOT EDIT
local _, ns = ...
ns.RegisterGuide({
    id = "GEN_HORDE_ORC_42_EASTERN_PLAGUELANDS",
    name = "42. Eastern Plaguelands 55-55 (Orc)",
    version = 2,
    faction = "Horde",
    race = { "Orc", "Troll" },
    minLevel = 55,
    ...
    next = "GEN_HORDE_ORC_43_BURNING_STEPPES",
    author = "ForeverGuide route planner",
    notes = "Chapter 42 of the Orc route: level 55 to 55, 34 steps, ~154 min of play in the model (54940 xp/h). Route tuned for xp per hour: low-value quests and long escorts are skipped on purpose; group (elite) quests appear as optional steps.",
    stepCount = 34,
