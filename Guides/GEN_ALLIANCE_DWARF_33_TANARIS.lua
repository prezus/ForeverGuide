-- AUTO-GENERATED by tools/compile_guides.py from guides-src/GEN_ALLIANCE_DWARF_33_TANARIS.json - DO NOT EDIT
local _, ns = ...
ns.RegisterGuide({
    id = "GEN_ALLIANCE_DWARF_33_TANARIS",
    name = "33. Tanaris 48-49 (Dwarf)",
    version = 2,
    faction = "Alliance",
    race = { "Dwarf", "Gnome" },
    minLevel = 48,
    ...
    map = 1446,
    zone = "Tanaris",
    next = "GEN_ALLIANCE_DWARF_34_UN_GORO_CRATER",
    author = "ForeverGuide route planner",
    notes = "Chapter 33 of the Dwarf route: level 48 to 49, 19 steps, ~56 min of play in the model (39737 xp/h). Route tuned for xp per hour: low-value quests and long escorts are skipped on purpose; group (elite) quests appear as optional steps (1 here).",
    stepCount = 19,
