-- AUTO-GENERATED by tools/compile_guides.py from guides-src/GEN_HORDE_TAUREN_40_EASTERN_PLAGUELANDS.json - DO NOT EDIT
local _, ns = ...
ns.RegisterGuide({
    id = "GEN_HORDE_TAUREN_40_EASTERN_PLAGUELANDS",
    name = "40. Eastern Plaguelands 54-54 (Tauren)",
    version = 2,
    faction = "Horde",
    race = { "Tauren" },
    minLevel = 54,
    ...
    next = "GEN_HORDE_TAUREN_41_SILITHUS",
    author = "ForeverGuide route planner",
    notes = "Chapter 40 of the Tauren route: level 54 to 54, 20 steps, ~81 min of play in the model (50154 xp/h). Route tuned for xp per hour: low-value quests and long escorts are skipped on purpose; group (elite) quests appear as optional steps.",
    stepCount = 20,
