-- AUTO-GENERATED by tools/compile_guides.py from guides-src/GEN_HORDE_SCOURGE_41_EASTERN_PLAGUELANDS.json - DO NOT EDIT
local _, ns = ...
ns.RegisterGuide({
    id = "GEN_HORDE_SCOURGE_41_EASTERN_PLAGUELANDS",
    name = "41. Eastern Plaguelands 55-55 (Undead)",
    version = 2,
    faction = "Horde",
    race = { "Scourge" },
    minLevel = 55,
    ...
    next = "GEN_HORDE_SCOURGE_42_BURNING_STEPPES",
    author = "ForeverGuide route planner",
    notes = "Chapter 41 of the Scourge route: level 55 to 55, 34 steps, ~154 min of play in the model (54940 xp/h). Route tuned for xp per hour: low-value quests and long escorts are skipped on purpose; group (elite) quests appear as optional steps.",
    stepCount = 34,
