-- AUTO-GENERATED by tools/compile_guides.py from guides-src/GEN_ALLIANCE_NIGHTELF_13_ARATHI_HIGHLANDS.json - DO NOT EDIT
local _, ns = ...
ns.RegisterGuide({
    id = "GEN_ALLIANCE_NIGHTELF_13_ARATHI_HIGHLANDS",
    name = "13. Arathi Highlands 30-31 (Night Elf)",
    version = 3,
    faction = "Alliance",
    race = { "NightElf" },
    minLevel = 30,
    ...
    notes = "Chapter 13 of the NightElf route: level 30 to 31, 38 steps, ~126 min of play in the model (29856 xp/h). Route tuned for xp per hour: low-value quests and long escorts are skipped on purpose; group (elite) quests appear as optional steps.",
    stepCount = 38,
