-- AUTO-GENERATED by tools/compile_guides.py from guides-src/GEN_HORDE_TAUREN_07_STRANGLETHORN_VALE.json - DO NOT EDIT
local _, ns = ...
ns.RegisterGuide({
    id = "GEN_HORDE_TAUREN_07_STRANGLETHORN_VALE",
    name = "7. Stranglethorn Vale 28-29 (Tauren)",
    version = 3,
    faction = "Horde",
    race = { "Tauren" },
    minLevel = 28,
    ...
    next = "GEN_HORDE_TAUREN_08_ARATHI_HIGHLANDS",
    author = "ForeverGuide route planner",
    notes = "Chapter 7 of the Tauren route: level 28 to 29, 37 steps, ~131 min of play in the model (20962 xp/h). Route tuned for xp per hour: low-value quests and long escorts are skipped on purpose; group (elite) quests appear as optional steps.",
    stepCount = 39,
