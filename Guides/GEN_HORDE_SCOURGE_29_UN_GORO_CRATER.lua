-- AUTO-GENERATED by tools/compile_guides.py from guides-src/GEN_HORDE_SCOURGE_29_UN_GORO_CRATER.json - DO NOT EDIT
local _, ns = ...
ns.RegisterGuide({
    ...
    map = 1449,
    zone = "Un'Goro Crater",
    next = "GEN_HORDE_SCOURGE_30_ORGRIMMAR",
    author = "ForeverGuide route planner",
    notes = "Chapter 29 of the Scourge route: level 49 to 49, 13 steps, ~67 min of play in the model (33176 xp/h). Route tuned for xp per hour: low-value quests and long escorts are skipped on purpose; group (elite) quests appear as optional steps.",
    stepCount = 13,
