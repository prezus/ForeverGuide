-- AUTO-GENERATED by tools/compile_guides.py from guides-src/GEN_HORDE_ORC_21_AZSHARA.json - DO NOT EDIT
local _, ns = ...
ns.RegisterGuide({
    id = "GEN_HORDE_ORC_21_AZSHARA",
    name = "21. Azshara 46-47 (Orc)",
    version = 2,
    faction = "Horde",
    race = { "Orc", "Troll" },
    minLevel = 46,
    ...
    map = 1447,
    zone = "Azshara",
    next = "GEN_HORDE_ORC_22_FELWOOD",
    author = "ForeverGuide route planner",
    notes = "Chapter 21 of the Orc route: level 46 to 47, 30 steps, ~129 min of play in the model (32492 xp/h). Route tuned for xp per hour: low-value quests and long escorts are skipped on purpose; group (elite) quests appear as optional steps.",
    stepCount = 30,
