-- AUTO-GENERATED by tools/compile_guides.py from guides-src/GEN_ALLIANCE_DWARF_47_EASTERN_PLAGUELANDS.json - DO NOT EDIT
local _, ns = ...
ns.RegisterGuide({
    id = "GEN_ALLIANCE_DWARF_47_EASTERN_PLAGUELANDS",
    name = "47. Eastern Plaguelands 55-55 (Dwarf)",
    version = 2,
    faction = "Alliance",
    race = { "Dwarf", "Gnome" },
    minLevel = 55,
    ...
    next = "GEN_ALLIANCE_DWARF_48_BURNING_STEPPES",
    author = "ForeverGuide route planner",
    notes = "Chapter 47 of the Dwarf route: level 55 to 55, 42 steps, ~180 min of play in the model (55191 xp/h). Route tuned for xp per hour: low-value quests and long escorts are skipped on purpose; group (elite) quests appear as optional steps.",
    stepCount = 42,
