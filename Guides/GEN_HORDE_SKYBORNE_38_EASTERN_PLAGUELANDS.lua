-- AUTO-GENERATED by tools/compile_guides.py from guides-src/GEN_HORDE_SKYBORNE_38_EASTERN_PLAGUELANDS.json - DO NOT EDIT
local _, ns = ...
ns.RegisterGuide({
    id = "GEN_HORDE_SKYBORNE_38_EASTERN_PLAGUELANDS",
    ...
    next = "GEN_HORDE_SKYBORNE_39_WESTERN_PLAGUELANDS",
    author = "ForeverGuide route planner",
    notes = "Chapter 38 of the Skyborne route: level 52 to 53, 20 steps, ~215 min of play in the model (15417 xp/h). Route tuned for xp per hour: low-value quests and long escorts are skipped on purpose; group (elite) quests appear as optional steps (1 here).",
    stepCount = 20,
