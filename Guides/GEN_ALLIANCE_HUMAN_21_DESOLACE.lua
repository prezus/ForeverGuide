-- AUTO-GENERATED by tools/compile_guides.py from guides-src/GEN_ALLIANCE_HUMAN_21_DESOLACE.json - DO NOT EDIT
local _, ns = ...
ns.RegisterGuide({
    ...
    notes = "Chapter 21 of the Human route: level 42 to 42, 9 steps, ~48 min of play in the model (30580 xp/h). Route tuned for xp per hour: low-value quests and long escorts are skipped on purpose; group (elite) quests appear as optional steps.",
    stepCount = 9,
