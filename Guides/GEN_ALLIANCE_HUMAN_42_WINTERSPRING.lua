-- AUTO-GENERATED by tools/compile_guides.py from guides-src/GEN_ALLIANCE_HUMAN_42_WINTERSPRING.json - DO NOT EDIT
local _, ns = ...
ns.RegisterGuide({
    ...
    map = 1452,
    zone = "Winterspring",
    next = "GEN_ALLIANCE_HUMAN_43_FELWOOD",
    author = "ForeverGuide route planner",
    notes = "Chapter 42 of the Human route: level 53 to 53, 28 steps, ~121 min of play in the model (34265 xp/h). Route tuned for xp per hour: low-value quests and long escorts are skipped on purpose; group (elite) quests appear as optional steps.",
    stepCount = 28,
