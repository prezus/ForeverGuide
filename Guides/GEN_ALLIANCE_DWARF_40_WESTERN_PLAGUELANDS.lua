-- AUTO-GENERATED by tools/compile_guides.py from guides-src/GEN_ALLIANCE_DWARF_40_WESTERN_PLAGUELANDS.json - DO NOT EDIT
local _, ns = ...
ns.RegisterGuide({
    id = "GEN_ALLIANCE_DWARF_40_WESTERN_PLAGUELANDS",
    name = "40. Western Plaguelands 52-52 (Dwarf)",
    version = 2,
    faction = "Alliance",
    race = { "Dwarf", "Gnome" },
    minLevel = 52,
    ...
    next = "GEN_ALLIANCE_DWARF_41_EASTERN_PLAGUELANDS",
    author = "ForeverGuide route planner",
    notes = "Chapter 40 of the Dwarf route: level 52 to 52, 9 steps, ~20 min of play in the model (80149 xp/h). Route tuned for xp per hour: low-value quests and long escorts are skipped on purpose; group (elite) quests appear as optional steps.",
    stepCount = 9,
