-- AUTO-GENERATED by tools/compile_guides.py from guides-src/GEN_HORDE_SCOURGE_38_WESTERN_PLAGUELANDS.json - DO NOT EDIT
local _, ns = ...
ns.RegisterGuide({
    id = "GEN_HORDE_SCOURGE_38_WESTERN_PLAGUELANDS",
    name = "38. Western Plaguelands 53-54 (Undead)",
    version = 2,
    faction = "Horde",
    race = { "Scourge" },
    minLevel = 53,
    ...
    notes = "Chapter 38 of the Scourge route: level 53 to 54, 13 steps, ~242 min of play in the model (8624 xp/h). Route tuned for xp per hour: low-value quests and long escorts are skipped on purpose; group (elite) quests appear as optional steps.",
    stepCount = 13,
