-- AUTO-GENERATED by tools/compile_guides.py from guides-src/GEN_HORDE_TAUREN_18_SEARING_GORGE.json - DO NOT EDIT
local _, ns = ...
ns.RegisterGuide({
    id = "GEN_HORDE_TAUREN_18_SEARING_GORGE",
    name = "18. Searing Gorge 45-45 (Tauren)",
    version = 2,
    faction = "Horde",
    race = { "Tauren" },
    minLevel = 45,
    ...
    map = 1427,
    zone = "Searing Gorge",
    next = "GEN_HORDE_TAUREN_19_BLASTED_LANDS",
    author = "ForeverGuide route planner",
    notes = "Chapter 18 of the Tauren route: level 45 to 45, 25 steps, ~106 min of play in the model (39495 xp/h). Route tuned for xp per hour: low-value quests and long escorts are skipped on purpose; group (elite) quests appear as optional steps.",
    stepCount = 25,
