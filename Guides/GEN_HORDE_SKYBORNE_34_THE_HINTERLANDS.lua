-- AUTO-GENERATED by tools/compile_guides.py from guides-src/GEN_HORDE_SKYBORNE_34_THE_HINTERLANDS.json - DO NOT EDIT
local _, ns = ...
ns.RegisterGuide({
    ...
    next = "GEN_HORDE_SKYBORNE_35_WESTERN_PLAGUELANDS",
