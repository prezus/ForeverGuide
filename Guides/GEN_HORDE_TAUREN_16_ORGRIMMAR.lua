-- AUTO-GENERATED by tools/compile_guides.py from guides-src/GEN_HORDE_TAUREN_16_ORGRIMMAR.json - DO NOT EDIT
local _, ns = ...
ns.RegisterGuide({
    id = "GEN_HORDE_TAUREN_16_ORGRIMMAR",
    name = "16. Orgrimmar 43-44 (Tauren)",
    version = 2,
    faction = "Horde",
    race = { "Tauren" },
    minLevel = 43,
    ...
    map = 1454,
    zone = "Orgrimmar",
    next = "GEN_HORDE_TAUREN_17_THE_HINTERLANDS",
    author = "ForeverGuide route planner",
    notes = "Chapter 16 of the Tauren route: level 43 to 44, 10 steps, ~18 min of play in the model (55483 xp/h). Route tuned for xp per hour: low-value quests and long escorts are skipped on purpose; group (elite) quests appear as optional steps.",
    stepCount = 10,
