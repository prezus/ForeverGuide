-- AUTO-GENERATED by tools/compile_guides.py from guides-src/GEN_ZONE_ALLIANCE_BADLANDS.json - DO NOT EDIT
local _, ns = ...
ns.RegisterGuide({
    ...
    steps = function() return {
        ...
        { type = "TURNIN", quest = 733, questName = "Scrounging", npc = 2860, npcName = "Sigrun Ironhew", map = 1418, zone = "Badlands", x = 53.8, y = 43.3 }, -- 16
