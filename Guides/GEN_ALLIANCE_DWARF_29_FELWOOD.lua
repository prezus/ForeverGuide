-- AUTO-GENERATED by tools/compile_guides.py from guides-src/GEN_ALLIANCE_DWARF_29_FELWOOD.json - DO NOT EDIT
local _, ns = ...
ns.RegisterGuide({
    id = "GEN_ALLIANCE_DWARF_29_FELWOOD",
    name = "29. Felwood 47-47 (Dwarf)",
    version = 2,
    faction = "Alliance",
    race = { "Dwarf", "Gnome" },
    minLevel = 47,
    ...
    map = 1448,
    zone = "Felwood",
    next = "GEN_ALLIANCE_DWARF_30_AZSHARA",
    author = "ForeverGuide route planner",
    notes = "Chapter 29 of the Dwarf route: level 47 to 47, 13 steps, ~61 min of play in the model (29336 xp/h). Route tuned for xp per hour: low-value quests and long escorts are skipped on purpose; group (elite) quests appear as optional steps.",
    stepCount = 13,
